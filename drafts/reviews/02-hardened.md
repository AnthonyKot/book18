# Essay 02 hardening log

No source contradiction or corrected number found.

- `02-cra-dates` — stamped; EUR-Lex Articles 14 and 71 support the reporting sequence and application dates.
- `02-cra-work` — stamped; EUR-Lex Article 13, Article 31 and Annex I support the lifecycle work described.
- `02-cra-roles` — stamped; EUR-Lex Articles 21–22 support both cases described.
- `02-subcontract-role` — inference; the inference rests on the statutory manufacturer definition, continuing manufacturer duty and the enumerated role-transfer cases, and still requires counsel engagement by engagement.
- `02-survey-pain` — stamped; the paper and arXiv submission history support the fieldwork dates, first posting year and summarised challenges.
- `02-survey-sample` — stamped; the paper supports the sample composition, manufacturer size and established IEC 62443-4-1 development lifecycles.
- `02-hard2bit-model` — stamped; the vendor page states all three delivery models, partner control of the contract and relationship, and that it publishes no margin percentages.
- `02-cybellum-partners` — stamped; the vendor page describes its solution-provider programme as combining professional services and its platform.
