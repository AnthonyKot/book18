...
4. **European Union, Regulation (EC) No 178/2002, General Food Law.** [Official text](https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=CELEX%3A32002R0178). Articles 18–19 support traceability and withdrawal responsibilities.
...
7. **European Union, Regulation (EU) 2023/1230 on machinery.** [Official text](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32023R1230) and [official corrigendum](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX%3A32023R1230R%2801%29). Article 18 supports the substantial-modification duty; correction 10 changes the Article 54 application date to 20 January 2027. This essay does not give conformity advice; the channel integrator must scope it for each installation.
...
10. **Cognex, In-Sight 3800 and image-acquisition documentation.** [Datasheet](https://www.cognex.com/support/downloads/ns/1/11/35/In-Sight%203800%20Datasheet.pdf); [image-sensor table](https://docs.cognex.com/isvs_2530/web/EN/is3800-manual/Content/Topics/specifications/imager-3800.htm?TocPath=Specifications%7C_____2); [system specifications](https://docs.cognex.com/isvs_2620/web/EN/is3800-manual/Content/Topics/specifications/specifications-3800.htm); [shutter explanation](https://www.cognex.com/en-nl/what-is/machine-vision/machine-vision-hardware-components); [exposure documentation](https://docs.cognex.com/isvidi_150/web/EN/Help_ISViDi/Content/Topics/Spreadsheet/VisionTools/AcquireImage.htm). Supports `03-cognex-ocr`, `03-cognex-spec`, `03-cognex-system`, `03-global-shutter` and `03-exposure-motion`. A component rating is not acceptance of the whole cell.
...
- The liability caps, indemnities, €2 million insurance requirement and claim stress are proposed validation hurdles. No broker quote or accepted customer contract yet supports them.
