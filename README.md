...
1. `CONTEXT.md` — thesis, reader, evidence standard, essay contracts and verdicts.
2. `AGENT.md` — research and writing rules.
3. `TEMPLATE.md` — common essay structure.
...
Run `./verify.sh` before publishing. The reader entry point is `index.html`.
